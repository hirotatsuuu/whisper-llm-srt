...
from src.llm_checker import refine_segments_with_grand_context  # 💡 llm_checker に美しく統一！
...
def main():
    ...
    llm_refined_segments = refine_segments_with_grand_context(cleaned_raw_segments, word_dict)
